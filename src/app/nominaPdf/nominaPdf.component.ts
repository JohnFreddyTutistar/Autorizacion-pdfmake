      ...
      content: [
        {
          ...
          table: {
            ...
            body: [
              [
                { rowSpan: 2, image: `data:image/png;base64,
                ...
                {text: 'GESTION DE TALENTO HUMANO', alignment: 'center', bold: true},
                {
                  table: {
                    widths: ['*'],
                    body: [
              ...
              ['',
              {text: 'AUTORIZACION DE DESCUENTO POR NOMINA', alignment: 'center', bold: true},
              {
                table: {
                  widths: ['*'],
                  body: [
        ...
        {text: '\n'},
        {
          ...
          table: {
            ...
            body: [
              [
                {text: 'FECHA\nDD/MM/AAAA', style: 'tableHeader', colSpan: 3, alignment: 'center', bold: true}, {}, {}
              ],
              [
     ...
     
        {
          alignment: 'justify',
          text: [
            'Yo ', {text: '____________________________________________________________'}, 
            ', Identificado con cédula de ciudadanía No.', {text: '_________________'},
            ', autorizo de manera expresa e irrevocable al ', {text: 'CENTRO DE CUIDADOS CARDIONEUROVASCULARES PABÓN S.A.S. y/o CLINICA CARDIONEUROVASCULAR PABON S.A.S,', bold: true},
            ', para descontar de mi salario, el valor correspondiente a $', {text: '__________________'},
            ', por concepto de: ', {text: '________________________________'},
        ...
        },
        {
          alignment: 'justify',
          text: [
            'Igualmente autorizo de manera expresa e irrevocable al ', {text: 'CENTRO DE CUIDADOS CARDIONEUROVASCULARES PABÓN S.A.S. y/o CLINICA CARDIONEUROVASCULAR PABON S.A.S,', bold: true},
...

        {
          ...
          table: {
            ...
            body: [
              [
                {text: 'NUMERO DE CUOTAS', bold: true, colSpan: 2, alignment: 'center'}, {}
              ],
              [
